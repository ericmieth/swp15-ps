...
def first_day(day) -> "date of the first weekday in current semester":
	"""Determines the the first date of a weekday in this semester
...
def semester_numbers(
	semester_numbers: "list of numbers which represent semesters",
	season: "\"s\" for summer-, \"w\" for winter-semester"=None
	) -> "relevant semester-numbers":
